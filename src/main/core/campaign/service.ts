 ...
 *
 * Sem isso as mensagens de disparo so apareciam na inbox quando o Baileys
 * ecoava o proprio envio via `messages.upsert` — o que pode demorar ou nao
 * acontecer. A insercao e idempotente pelo id da mensagem, entao quando o
 * eco chegar ele nao duplica nada.
 */
